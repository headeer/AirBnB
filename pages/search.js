        ...
        <div className='h-screen'>
            ...
            <main className="flex">
                <section className='flex-grow pt-14 px-6 '>
                    ...
                    {searchResults.map(({location, title, description, star, price, total, img}) => (
                        <InfoCard description={description} location={location} title={title} star={star} price={price} total={total} img={img} />
                    ))
